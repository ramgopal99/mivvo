...
export default function WritingResultPage() {
  ...
  const [sessionData, setSessionData] = useState<WritingSessionData | null>(null)
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading writing results...</p>
        </div>
      </div>
    )
  }
  ...
  return <WritingResultsContent session={sessionData} />
}