...
export function SpeakingResultsContent({ session }: SpeakingResultsContentProps) {
  ...
  const getAttemptScore = (attempt: SpeakingSessionAttempt) => {
  ...
  const getAttemptAnalysis = (attempt: SpeakingSessionAttempt) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-900">Speaking & Listening Session Attempts</h2>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-600 text-center">
                You haven&apos;t completed any speaking and listening practice attempts yet.
              </p>
            </CardContent>
          </Card>
        ) : (
                      ...
                      if (hasAnyData) {
                        return (
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => router.push(`/dashboard/foreign-lang/speaking/${session.id}/attempt/${attempt.id}`)}
                  ...
                  if (hasAnyData) {
                      ...
                      <CardContent>
                        <div className="text-center py-4">
                          <div className="text-sm text-gray-500">
                            Speaking session completed but no detailed analysis available.
                          </div>
                        </div>
                      </CardContent>
                    )
                    ...
                    return (
                      <CardContent>
                        <div className="text-center py-4">
                          <div className="text-sm text-gray-500">
                            Speaking session not completed.
                          </div>
                        </div>
                      </CardContent>
                    )
