    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading speaking history...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex flex-col text-center flex-1 mx-8">
          <h1 className="text-3xl font-bold text-gray-900 leading-tight">Speaking Practice History</h1>
          <p className="text-gray-600 text-lg mt-1">
            Review your speaking progress and detailed AI analysis
          </p>
        </div>
      </div>
        ...
        {attempts.length === 0 ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Speaking Attempts Yet</h3>
              <p className="text-gray-500 text-center mb-4">
                Start your first speaking practice session to see your progress and detailed AI analysis here.
              </p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold">Your Speaking Attempts</h2>
              ...
              <Card key={attempt.id} className="hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => router.push(`/dashboard/foreign-lang/speaking/${attempt.sessionId}/attempt/${attempt.id}`)}
                    >
                      View Details
                    </Button>
                  </div>
