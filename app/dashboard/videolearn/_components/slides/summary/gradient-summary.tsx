...
/** Gradient summary: full-bleed gradient bg with polished overlay and strong contrast. */
export function GradientSummary({ title, points, isPlaying, animationClass, className }: SummarySlideProps) {
