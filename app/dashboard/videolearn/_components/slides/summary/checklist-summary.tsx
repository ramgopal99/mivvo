...
/** Checklist summary: checkmark-style list with success styling. */
export function ChecklistSummary({ title, points, isPlaying, animationClass, className }: SummarySlideProps) {
      ...
      <ul className="space-y-4">
        {points.map((point, i) => (
          ...
          >
            ...
            <span className="text-base md:text-lg text-foreground/90 leading-relaxed pt-0.5">{point}</span>
          </li>
        ))}
      </ul>
    </div>
