...
/** Numbered bullets: 1, 2, 3… with accent badges. */
export function NumberedBullets({ title, bullets, isPlaying, animationClass, className }: BulletSlideProps) {
      ...
      <ol className="space-y-5 w-full">
        {bullets.map((bullet, i) => (
          ...
          >
            ...
            <span className="text-base md:text-lg text-foreground/90 leading-relaxed pt-1.5">{bullet}</span>
          </li>
        ))}
      </ol>
    </div>
