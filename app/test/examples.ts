...
import LanguageTestWrapper from './language-test-wrapper';
import { CURRENT_COURSE, getCurrentCourse, isCourseAvailable } from './course-config';

// =============================================
// EXAMPLE 1: Basic Usage (Uses config automatically)
// =============================================

// This will automatically use the course set in course-config.ts
...
/*
To switch courses, simply change the CURRENT_COURSE variable in course-config.ts:
