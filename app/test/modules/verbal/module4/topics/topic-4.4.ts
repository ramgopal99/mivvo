...
- **Grammar**: Parts of speech, tense, structure
- **Context**: Logical flow and coherence
...
2. **Identify blank requirements** (part of speech, meaning)
3. **Check each option** for grammatical fit
4. **Verify logical coherence** with surrounding words
...
2. **Wrong Part of Speech**: Noun when verb is needed, etc.
3. **Collocation Errors**: Words that don't naturally go together
4. **Connotation Mismatch**: Wrong emotional tone for the sentence
...
1. The ________ of the new policy was immediate.
   - (a) affect (b) effect (c) effort (d) afford

2. She has been ________ for the job for six months.
   - (a) applying (b) requesting (c) asking (d) seeking

3. His ________ behavior impressed the interviewers.
   - (a) confident (b) confidential (c) confident (d) confiding

4. The ________ was too complicated to understand.
   - (a) simple (b) complex (c) easy (d) clear

**Answers:** 1-(b), 2-(a), 3-(a), 4-(b)

### Exercise 2: Grammar-Based Completion
**Fill blanks based on grammatical rules:**

1. Each of the participants ________ a certificate.
   - (a) receive (b) receives (c) receiving (d) received

2. If I ________ you, I would study harder.
   - (a) am (b) was (c) were (d) be

3. The committee ________ decided to postpone the meeting.
   - (a) has (b) have (c) having (d) had

4. Neither the teachers nor the principal ________ present.
   - (a) was (b) were (c) are (d) is

**Answers:** 1-(b), 2-(c), 3-(a), 4-(b)

### Exercise 3: Preposition Completion
**Choose the appropriate preposition:**

1. He is famous ________ his paintings.
   - (a) by (b) for (c) in (d) at

2. The cat is sleeping ________ the table.
   - (a) on (b) in (c) under (d) at

3. She depends ________ her parents for support.
   - (a) at (b) on (c) in (d) with

4. We arrived ________ the airport ________ time.
   - (a) at...in (b) in...on (c) on...at (d) at...on

**Answers:** 1-(b), 2-(c), 3-(b), 4-(a)

### Exercise 4: Idiom Completion
**Complete with appropriate idiomatic expressions:**

1. When he won the lottery, he was ________.
   - (a) on cloud nine (b) under the weather (c) in hot water (d) on thin ice

2. You should ________ before making an important decision.
   - (a) hit the books (b) break a leg (c) sleep on it (d) kick the bucket

3. Don't ________ the boat by arguing with the boss.
   - (a) rock (b) shake (c) tip (d) move

4. The new employee is not doing his share. He needs to ________.
   - (a) burn the midnight oil (b) go the extra mile (c) pull his weight (d) cut corners

**Answers:** 1-(a), 2-(c), 3-(a), 4-(c)

### Exercise 5: Contextual Completion
**Choose words that fit the context:**

1. The ________ storm caused flooding in the city.
   - (a) beautiful (b) severe (c) pleasant (d) mild

2. His ________ remarks offended everyone at the party.
   - (a) polite (b) courteous (c) insulting (d) complimentary

3. The scientist made an important ________ in medical research.
   - (a) discovery (b) invention (c) creation (d) finding

4. She showed remarkable ________ during the crisis.
   - (a) weakness (b) courage (c) fear (d) hesitation

**Answers:** 1-(b), 2-(c), 3-(a), 4-(b)

### Exercise 6: Advanced Completion
**Complete with the most appropriate word:**

1. The ________ of his argument was not convincing.
   - (a) logic (b) logical (c) logically (d) logistical

2. She has a ________ knowledge of classical music.
   - (a) deep (b) deeply (c) depth (d) deepen

3. The team's ________ was evident in their performance.
   - (a) unite (b) unity (c) united (d) unifying

4. His ________ to the problem surprised everyone.
   - (a) solve (b) solution (c) solvable (d) solvent
...
|---|---|---|
| **Vocabulary** | The ________ weather... | Word meaning & context |
| **Grammar** | Each student ________... | Subject-verb agreement |
| **Preposition** | Interested ________ math | Correct preposition |
| **Idiom** | On ________ nine | Idiomatic expression |
| **Collocation** | Severe ________ | Natural word pairs |
...
- **Master grammar rules** for grammar-based blanks
