...
- **Word Usage**: Prepositions, articles, confusable words
- **Sentence Structure**: Parallelism, modifiers, clauses
...
2. **Check subject-verb agreement** (most common error)
3. **Verify tense consistency** throughout
4. **Examine pronouns** for agreement and case
5. **Test prepositions** and articles
6. **Check parallel structure** in lists
7. **Look for modifier issues**
...
2. **Quantifiers**: Some, any, all, none, each, every
3. **Collective Nouns**: Team, committee, family, group
4. **Relative Clauses**: Who, which, that, whose
...
1. The committee **has** decided to meet tomorrow.
   - (a) has (b) decided (c) to meet (d) No error

2. Each of the students **were** present in the class.
   - (a) Each (b) were (c) present (d) No error

3. Neither the teacher nor the students **is** responsible.
   - (a) Neither (b) nor (c) is (d) No error

**Answers:** 1-(d), 2-(b), 3-(c)

### Exercise 2: Tense Errors
**Identify the tense mistake:**

1. He **goes** to school and **has studied** there for years.
   - (a) goes (b) has studied (c) for years (d) No error

2. I **will have completed** the project by next week.
   - (a) will have completed (b) the project (c) by next week (d) No error

3. She **has been working** here **since** five years.
   - (a) has been working (b) here (c) since (d) No error

**Answers:** 1-(a), 2-(d), 3-(c)

### Exercise 3: Pronoun Errors
**Find the pronoun mistake:**

1. The teacher asked the boys to bring **their** books.
   - (a) teacher (b) asked (c) their (d) No error

2. **One** should help **his or her** friends.
   - (a) One (b) should (c) his or her (d) No error

3. She is taller than **me**.
   - (a) She (b) is (c) me (d) No error

**Answers:** 1-(d), 2-(d), 3-(c)

### Exercise 4: Preposition Errors
**Spot the preposition mistake:**

1. He is interested **in** science.
   - (a) interested (b) in (c) science (d) No error

2. The meeting is **on** Monday.
   - (a) meeting (b) is (c) on (d) No error

3. She depends **on** her parents.
   - (a) depends (b) on (c) parents (d) No error

**Answers:** 1-(d), 2-(c), 3-(d)

### Exercise 5: Parallel Structure
**Find the parallelism error:**

1. He likes **reading** books, **to write** stories, and **swimming**.
   - (a) reading (b) to write (c) swimming (d) No error

2. The course covers **grammar**, **vocabulary**, and **how to write** essays.
   - (a) grammar (b) vocabulary (c) how to write (d) No error

3. She **enjoys** **reading**, **writing**, and **painting**.
   - (a) enjoys (b) reading (c) writing (d) No error

**Answers:** 1-(b), 2-(c), 3-(d)

### Exercise 6: Modifier Errors
**Identify modifier mistakes:**

1. **Having finished** the homework, the movie was watched.
   - (a) Having finished (b) the homework (c) was watched (d) No error

2. I saw **a man** with a beard **walking** down the street.
   - (a) a man (b) with a beard (c) walking (d) No error

3. **To pass** the exam, hard work is necessary.
   - (a) To pass (b) the exam (c) is necessary (d) No error
...
|---|---|---|
| **S-V Agreement** | Plural subject + singular verb | Count the subject |
| **Tense** | Mixed time references | Check timeline |
| **Pronouns** | Case, number, reference | Trace antecedents |
| **Prepositions** | Wrong word in phrases | Test alternatives |
| **Articles** | A/an/the misuse | Sound/meaning check |
| **Parallel** | Mixed structures in lists | Compare elements |
| **Modifiers** | Unclear modification | Check placement |
| **Punctuation** | Missing/wrong marks | Read aloud |
...
4. **Test preposition correctness**
