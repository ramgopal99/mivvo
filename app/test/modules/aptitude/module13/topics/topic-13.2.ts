...
- Use addition/subtraction properties
...
- Substitute the value back into original equation
...
### **Example: Using Transposition**
**Solve:** \`5x - 8 = 3x + 12\`

**Step 1:** Transpose terms
- Bring x terms to left: \`5x - 3x = 12 + 8\`
- Bring constants to right: \`5x - 3x = 12 + 8\`
...
### **Case 2: Contradiction (No Solutions)**
**Equation:** \`2x + 3 = 2x + 5\`
...
### **Special Cases:**
1. Solve: \`2x + 3 = 2x + 3\` (Identity)
2. Solve: \`3x - 5 = 3x + 2\` (Contradiction)
...
3. **Handle fractions carefully** - multiply to eliminate
4. **Check for special cases** (infinite/no solutions)
5. **Practice word problems** regularly
6. **Maintain balance** - same operation on both sides
7. **Look for common mistakes** in calculations
