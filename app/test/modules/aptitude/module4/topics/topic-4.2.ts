...
- **Grades**: "85%" vs "17/20"
- **Sports**: "75% success rate" vs "3/4 accuracy"
- **Finance**: "5% interest" vs "1/20 rate"

### **Mathematical Importance**
- Percentages are easier for comparison
...
| 1/10     | 0.1     | 10%        | Tenth = 10% |
| 1/20     | 0.05    | 5%         | Twentieth = 5% |

### **Percentage to Fraction - Common Values**
...
2. Convert 7/10 to percentage = ?
3. Convert 3/8 to percentage = ?
4. Convert 5/4 to percentage = ?
5. Convert 2/3 to percentage = ?

### **Percentage to Fraction:**
1. Convert 40% to fraction = ?
2. Convert 65% to fraction = ?
3. Convert 125% to fraction = ?
4. Convert 8.5% to fraction = ?
...
5. **Practice mental math** for quick conversions under time pressure
