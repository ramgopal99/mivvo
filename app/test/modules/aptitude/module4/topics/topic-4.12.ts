...
2. **Identify type** - Increase, decrease, comparison, etc.
3. **Choose formula** - Select appropriate percentage formula
4. **Calculate step-by-step** - Show all work
...
**Solution:**
- Let x L water added
- Alcohol remains same: 80% of 10 = 8L
...
**Solution:**
- Adults + Children + Elderly = 100%
- Elderly = 100% - 40% - 30% = 30%
- Number = 30% of 2,00,000 = 60,000

### **Problem 3: Literacy Rate**
**Question:** Village 5000 people. Literacy rate 75%. How many literate?

**Solution:**
- Literate = 75% of 5000 = 3,750
...
2. Three candidates got 40%, 35%, 25% votes. Total votes 20,000. Find each candidate's votes.
...
3. **Choose correct base** - CP for profit%, MP for discount%
4. **Don't add percentages** - Use compound effect when needed
5. **Check units** - Money in rupees, population in numbers
6. **Estimate answer** - Verify if calculation makes sense
7. **Break complex problems** - Solve step by step
