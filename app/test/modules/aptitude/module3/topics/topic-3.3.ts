...
export const topic_3_3: SubLesson = {
  ...
  title: 'Brackets ((), {}, [])',
  status: 'completed',
  content: "`# ðŸ”¢ Understanding Brackets
...
### Example:
**Simplify: 2 Ã— {3 + [4 Ã— (5 - 2)]}**

**Step 1:** Solve parentheses: (5 - 2) = 3  
**Step 2:** Solve square brackets: [4 Ã— 3] = 12  
**Step 3:** Solve curly brackets: {3 + 12} = 15  
**Step 4:** Final multiplication: 2 Ã— 15 = 30

---

## ðŸŽ¯ Common Bracket Operations
...
**Examples:**
- ((2 + 3) Ã— 4) = (5 Ã— 4) = 20
- 2 Ã— ((3 + 4) - 1) = 2 Ã— (7 - 1) = 2 Ã— 6 = 12

---

## ðŸ§® Expanding Expressions with Brackets
...
- (x + 2)(x + 3) = x(x + 3) + 2(x + 3) = xÂ² + 3x + 2x + 6 = xÂ² + 5x + 6

### **Nested Brackets**
**Examples:**
- 2[3 + (4 Ã— 2)] = 2[3 + 8] = 2[11] = 22
- 3{2 + [4 Ã— (5 - 2)]} = 3{2 + [4 Ã— 3]} = 3{2 + 12} = 3{14} = 42

---

## ðŸŽ¯ Special Bracket Rules
...
- \\frac{a + b}{c Ã— d} = \\frac{a + b}{c Ã— d}

### **Brackets in Complex Fractions**
**Examples:**
- \\frac{1 + \\frac{1}{2}}{3} = \\frac{\\frac{3}{2}}{3} = \\frac{1}{2}
- \\frac{a}{b + \\frac{c}{d}} = \\frac{a}{\\frac{bd + c}{d}} = \\frac{a Ã— d}{bd + c}

---

## ðŸš¨ Common Mistakes with Brackets

### âŒ **Wrong Order of Solving**
\`"\`\`
Wrong: 2 Ã— [3 + (4 Ã— 5)] = 2 Ã— [3 + 4] Ã— 5 = 14 Ã— 5 = 70
Right: 2 Ã— [3 + (4 Ã— 5)] = 2 Ã— [3 + 20] = 2 Ã— 23 = 46
\`\`\`

### âŒ **Incorrect Sign Change**
\`\`\`
Wrong: 5 - (2 + 3) = 5 - 2 + 3 = 6
Right: 5 - (2 + 3) = 5 - 5 = 0
\`\`\`

### âŒ **Missing Multiplication**
\`\`\`
Wrong: 2(3 + 4) = 2 Ã— 3 + 4 = 10
Right: 2(3 + 4) = 2 Ã— 3 + 2 Ã— 4 = 6 + 8 = 14
\`\`\`

### âŒ **Wrong Bracket Priority**
\`\`\`
Wrong: {2 + [3 Ã— (4 + 5)]} = {2 + [3 Ã— 4 + 5]} = {2 + [12 + 5]} = 19
Right: {2 + [3 Ã— (4 + 5)]} = {2 + [3 Ã— 9]} = {2 + 27} = 29
\`\`\`

---

## ðŸŽ¯ Advanced Bracket Problems

### **Multiple Levels**
**Simplify: 3 - {2 + [4 Ã— (5 - 2)] + 1}**
...
**Answers:** 12, 3, 20, 22, 30, -8, 42, 2, 2a+2b+2c, -3x-6y, xÂ²+3x+2
...
Master brackets and you'll handle even the most complex simplification problems! ðŸ†`
};
