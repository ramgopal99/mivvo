...
Represent same value: 1/2 = 2/4 = 3/6
...
Common denominator 6: 3/6 and 4/6, so 1/2 < 2/3
...
**Example**: 2.5 + 1/2
Convert 2.5 to 5/2, then 5/2 + 1/2 = 6/2 = 3

### Trick 2: **Simplification**
...
Can be positive or negative: -2/3, 2/(-3) = -2/3
...
Rate: A=1/6, B=1/8, Together=1/6+1/8=14/48=7/24 per day
Time = 24/7 days
