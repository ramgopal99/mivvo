...
- Periodic rate = Annual rate ÷ 4
- Time measured in quarters

---

## 📊 Quarterly Compounding Formulas
...
**Problem:** ₹10,000 at 10% quarterly CI for 2 years.

**Step 1:** Calculate periodic rate
- Quarterly rate = 10% ÷ 4 = 2.5%

**Step 2:** Number of periods
- 2 years × 4 = 8 quarterly periods

**Step 3:** Apply formula
- A = 10,000 × (1 + 2.5/100)^8
- A = 10,000 × (1.025)^8
- A = 10,000 × 1.218402 = ₹12,184.02
- CI = 12,184.02 - 10,000 = ₹2,184.02

### **Example 2: Comparison with Annual**
**Problem:** Compare ₹10,000 at 10% for 2 years: annual vs quarterly.

**Annual:** A = 10,000 × (1.10)^2 = ₹12,100
**Quarterly:** A = 10,000 × (1.025)^8 = ₹12,184.02

**Difference:** ₹84.02 more with quarterly
...
- EAR = (1 + 10/400)^4 - 1 = (1.025)^4 - 1 ≈ 1.1038 - 1 = 10.38%
...
2. P = ₹1500, R = 12%, T = 1.5 years. Find A and CI.
3. P = ₹5000, R = 6%, T = 3 years. Find A and CI.

### **Comparison Problems:**
1. Compare annual vs quarterly for ₹10000 at 12% for 2 years.
2. Find EAR for 10% quarterly compounding.

**Answers:**
Basic: A ₹2345.92, CI ₹345.92; A ₹1858.29, CI ₹358.29; A ₹5970.93, CI ₹970.93
Comparison: Annual ₹12,544, Quarterly ₹12,583.68; 10.38%

Master quarterly compounding for maximum compounding frequency benefits! 🏆`
};