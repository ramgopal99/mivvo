...
export const topic_9_2: SubLesson = {
  ...
  status: 'completed',
  content: `# 📈 Rate of Interest (R) in Compound Interest
...
- For quarterly: Nominal rate ÷ 4
- For monthly: Nominal rate ÷ 12

---

## 🧮 Rate Calculations in CI

### **Finding Effective Annual Rate**
\`\`\`
EAR = (1 + Nominal Rate/(100×n))^n - 1
\`\`\`
...
**Problem:** ₹10,000 at 12% nominal annual rate. Compare annual vs quarterly compounding for 1 year.

**Annual Compounding:**
- A = 10,000 × (1 + 12/100)^1 = ₹11,200
- Effective rate = 12%

**Quarterly Compounding:**
- A = 10,000 × (1 + 12/400)^4 = 10,000 × (1.03)^4
- A = 10,000 × 1.1255 = ₹11,255
...
**9.5% Half-yearly:**
- EAR = (1 + 9.5/200)^2 - 1 = (1.0475)^2 - 1 ≈ 9.70%

**Result:** 10% annual is better (10% > 9.70%)

---

## 💡 Rate Frequency Effects
...
❌ "10% monthly = 120% annual"
- 10% monthly = about 127.6% effective annual

### **Mistake 2: Wrong Periodic Rate**
❌ "12% annual for quarterly = 3% quarterly"
- Quarterly rate = 12% ÷ 4 = 3%, yes
...
❌ "Higher nominal rate is always better"
...
Master rate of interest in compound interest for optimal financial decisions! 🏆`
};