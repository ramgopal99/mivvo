...
- Efficiency A : B = 2:1
- Time A : B = 1:2
- A takes 20/2 = 10 days

### Example 2: Multiple Workers
**A, B, C efficiencies 3:2:1. They work together. Combined efficiency relative to A?**

**Solution:**
- Combined efficiency = 3 + 2 + 1 = 6
- A's efficiency = 3
- Combined = 6/3 = 2 times A's efficiency

### Example 3: Work Distribution
**A (efficiency 4), B (efficiency 3) work together for 5 days, complete 35 units. A's contribution?**
...
\`\`\`
If efficiencies are a:b:c
Time taken will be c:b:a for same work
\`\`\`

### **Quick Efficiency Calculation**
\`\`\`
Efficiency = Work done / Time taken
Compare efficiencies by comparing work/time ratios
\`\`\`
...
- **Experience-based**: Senior vs junior staff
- **Machine-based**: Different machine capacities
- **Time-based**: Morning vs evening productivity

### **Efficiency Changes**
- **Learning curve**: Efficiency increases over time
- **Fatigue factor**: Efficiency decreases over time
- **Motivation factor**: Higher efficiency with incentives
- **Environmental factors**: Weather, conditions affecting work

### **Partial Efficiency**
- **Part-time work**: Reduced working hours
- **Multi-tasking**: Divided attention, lower efficiency
- **Interruptions**: Breaks reducing effective time
...
3. **Time Application**: Apply efficiency to actual working time
4. **Partial Efficiency**: Account for reduced working periods
5. **Zero Efficiency**: Impossible - minimum efficiency > 0
...
**3.** A (eff 5) works 4 days, B (eff 3) works 6 days. Work ratio?
**4.** A is 40% more efficient than B. B takes 20 days. A takes?
**5.** Combined efficiency of A (eff 6) and B (eff 4) = ?

**Answers:** 1. 10 days, 2. 9 units/day, 3. 20:18 = 10:9, 4. 14.29 days, 5. 10 units/day
...
3. **Account for actual working time** - not just calendar time
