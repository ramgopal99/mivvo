...
### Key Concepts:
- **Total Work = 1 unit** (or 100% or any convenient unit)
- **Work Done** = Fraction of total work completed
- **Time Taken** = Time required to complete the work
...
- **Percentage**: 25%, 50%, 75%, etc.
- **Days**: 5 days, 10 days, etc.
- **Hours**: 6 hours, 12 hours, etc.
...
**Solution:** A completes 1/10th of work in 1 day.
...
\`\`\`
Work done by multiple people = Sum of individual works
\`\`\`

### 2. **Time Proportionality**
\`\`\`
If A takes 'n' times more time than B, then A's efficiency is 1/nth of B's efficiency.
\`\`\`

### 3. **Work Conservation**
\`\`\`
Total work completed = Work by A + Work by B + Work by C + ...
\`\`\`
...
A's efficiency : B's efficiency = b : a
\`\`\`

### **Work Fraction Magic**
- **Half work**: Takes same time as full work (for same efficiency)
- **Double efficiency**: Half the time
- **Triple workers**: One-third the time
...
3. **Time Confusion**: More workers = Less time (not more time)
4. **Fraction Errors**: 1/2 + 1/3 = 5/6, not 1/5
...
**2.** If 3 men complete 2/3rd of work in 8 days, how many more men needed to complete remaining work in 2 days?

**3.** A does 2/5th of work in 6 days. B does remaining work in 9 days. In how many days can B alone complete full work?

**Answers:** 1. 7/60, 2. 4 men, 3. 13.5 days
...
3. **Use fractions for precision** - avoid decimals when possible
