...
A's efficiency = 1/n (per day)
A's efficiency = 100/n percent (per day)
\`\`\`
...
- A's efficiency = 1/12
- B's efficiency = 1/18
- A:B efficiency = 18:12 = 3:2
- A is 50% more efficient than B

### Example 3: Time from Efficiency
...
- **Per day**: Work/day
- **Per hour**: Work/hour
- **Percentage**: % of work completed per unit time

### **Efficiency Variations**
- **Constant efficiency**: Same rate throughout
- **Variable efficiency**: Changes over time
- **Partial efficiency**: Works only part of the time

### **Efficiency and Breaks**
\`\`\`
Effective efficiency = Actual work time / Total available time
\`\`\`
...
**Solution:** A:B = 100:80 = 5:4

### Example 5: Worker Comparison
**A completes 3/5 work in 12 days. B completes 2/3 work in 10 days. Who is more efficient?**

**Solution:**
- A's efficiency = (3/5)/12 = 1/20 per day
- B's efficiency = (2/3)/10 = 1/15 per day
- B is more efficient (1/15 > 1/20)

### Example 6: Efficiency and Overtime
...
3. **Unit Confusion**: Convert to same time units
4. **Zero Efficiency**: Impossible - minimum efficiency > 0
5. **Negative Efficiency**: Doesn't exist
...
**3.** A does 2/5 work in 8 days. A's efficiency per day?
**4.** A:B:C efficiency = 3:4:5. Time ratio for same work?
**5.** Machine produces 120 units/hour. Efficiency if target is 100 units/hour?

**Answers:** 1. 3:2, 2. 12.8 days, 3. 1/20, 4. 20:15:12, 5. 120/100 = 1.2x
...
3. **Convert to same units** - hours, days, minutes
