...
### **Types of False Weight**
1. **Less Weight**: Shows more, gives less
2. **More Weight**: Shows less, gives more (loss)
3. **False Measurement**: Incorrect volume measures

### **Key Concept**
- Profit comes from weight difference
- CP is based on actual weight given
- SP is based on weight shown/billed
...
**Where:**
- True Weight = Actual weight given
- False Weight = Weight shown/billed
...
### **Example 2: Scale Error**
**Problem:** Scale shows 20% more than actual. Find gain %.
...
- SP is amount charged for billed weight (1000g)
- Profit comes from overcharging for actual goods supplied

### **Per Transaction Analysis**
- Cost incurred: For 900g
- Revenue received: For 1000g
- Profit: On the 100g difference
...
\`\`\`
If scale shows X% more/less than actual
Gain/Loss % = X%
\`\`\`
...
\`\`\`
Overall gain depends on transaction volume
\`\`\`
...
2. Scale shows 15% more. Find gain %.
3. Shows 500g, gives 450g. Find gain %.

### **Application Problems:**
1. 1 liter can holds 950ml. Find gain %.
2. Scale error of 50g on 1kg. Find gain %.
3. Shows 2kg, gives 1.8kg. Find gain %.
