...
### **Key Points**
- CP is the base price for calculations
- All profits and losses are calculated relative to CP
- CP determines the break-even point

### **Components of Cost Price**
1. **Purchase Price**: Amount paid to supplier
2. **Transportation Cost**: Freight and handling charges
3. **Taxes**: GST, excise duty, etc.
4. **Loading/Unloading**: Labor costs
5. **Insurance**: During transit
6. **Packaging**: Cost of packaging materials
7. **Storage**: Warehouse costs
...
- Manufacturing cost for producers
- Basic acquisition cost

### **2. Total Cost Price (CP)**
- Direct cost + all additional expenses
- Complete cost incurred
- Base for profit/loss calculations

### **3. Invoice Price**
- Price mentioned on invoice
- May or may not include transportation

### **4. Landing Cost**
- Total cost including transportation
- Complete cost at destination
...
### **2. Retail Purchase**
\`\`\`
CP = Invoice Price + Transportation + Unloading + Local Taxes
\`\`\`

### **3. Manufacturing**
\`\`\`
CP = Raw Materials + Labor + Factory Overheads + Depreciation
\`\`\`

### **4. Import Purchase**
\`\`\`
CP = CIF Price + Customs Duty + Clearing Charges + Local Transportation
\`\`\`
...
- Minimum SP = CP (no profit no loss)
...
|------------|-------------|----------|
| Cost Price | Total acquisition cost | Profit/loss base |
| Selling Price | Price to customer | Revenue generation |
| Marked Price | Display price | Discount calculations |
| Market Price | Current market rate | Competitive analysis |
...
\`\`\`
CP = Direct Cost + Indirect Costs + Taxes + Transportation
\`\`\`
