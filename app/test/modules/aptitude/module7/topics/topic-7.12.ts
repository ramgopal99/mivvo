...
- **Variable Costs**: Costs that change with production (materials, labor)
...
**Meaning:** Sell 1,000 units to cover all costs.
...
### **1. Multiple Products**
\`\`\`
Weighted contribution based on product mix
\`\`\`

### **2. Target Profit**
\`\`\`
Units needed = (FC + Target Profit) / Contribution per unit
\`\`\`

### **3. Price Changes**
\`\`\`
Break-even changes with SP or cost changes
\`\`\`
...
- **Total Cost Line**: Fixed cost + variable costs
- **Sales Revenue Line**: Sales at different volumes
- **Break-even Point**: Intersection of total cost and revenue

### **Interpretation**
- Above break-even: Profit area
- Below break-even: Loss area
- Steeper sales line = better profitability
