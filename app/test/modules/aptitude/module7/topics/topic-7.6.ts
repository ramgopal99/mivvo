...
- Negative profitability indicator
- Used for loss analysis and risk assessment
...
- Can be recovered through volume

### **2. Significant Loss (5-15%)**
- Concerning, needs investigation
- May indicate pricing or cost issues
...
- Usually less than profit margin
...
### **2. Recovery Factor**
\`\`\`
Required Volume Increase = Loss % / Profit Margin %
\`\`\`

### **3. Break-even Point**
- Point where losses stop
