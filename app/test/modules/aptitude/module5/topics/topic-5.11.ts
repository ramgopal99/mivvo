...
### **1. Direct Proportion**
\`\`\`
First and third terms are to second and fourth terms
\`\`\`
...
\`\`\`
Find what b corresponds to c, then scale for a
\`\`\`

### **Trick 3: Simplify Before Calculating**
\`\`\`
Reduce fractions to simplest terms first
\`\`\`
