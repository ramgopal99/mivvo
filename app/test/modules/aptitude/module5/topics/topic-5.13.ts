...
2. **Find relationship** - Direct, inverse, or other proportion?
3. **Set up ratio/equation** - Express mathematically
4. **Solve systematically** - Use appropriate method
5. **Verify answer** - Check if it makes sense

### **Key Words to Watch**
- **Ratio of** - Direct ratio comparison
- **Proportion** - Relative quantities
- **Mixture** - Component ratios
- **Age difference** - Time-based ratios
...
**Solution:**
- Let current ages: 3k, 4k
- After 4 years: 3k+4, 4k+4
- Ratio: (3k+4)/(4k+4) = 7/9
- 9(3k+4) = 7(4k+4)
- 27k + 36 = 28k + 28
- k = 8
...
**Question:** Sum of ages 45. Ratio 2:3. Find ages.
...
**Question:** Car travels 60km at 30km/h, remaining 60km at 40km/h. Average speed?
...
- A's 1 day work = 1/10
- B's 1 day work = 1/15
- Together: 1/10 + 1/15 = 1/6
- Time = 6 days

### **Problem 2: Leave & Join**
**Question:** A does work in 12 days. Works 6 days, B joins. Complete in 4 more days. B's time alone?

**Solution:**
- Work done by A in 10 days = 10/12 = 5/6
- Work left = 1/6
- Work by A and B in 4 days = 1/6
- 1 day work of A and B = (1/6)/4 = 1/24
- A's 1 day work = 1/12
- B's 1 day work = 1/24 - 1/12 = 1/24
- B alone = 24 days
...
2. Ratio becomes 5:6 after 5 years. Current ratio 3:4. Find ages.

### **Mixture Problems:**
1. Mix 15L 40% with x L 60% to get 50%. Find x.
2. 20L 30% solution, evaporate 5L water. New concentration?

### **Work Problems:**
1. A completes in 12 days, B in 18 days. Together?
2. A works 8 days, B joins, complete in 6 more days. B's alone time?
