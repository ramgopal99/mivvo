...
- **Ratio A:B**: Quantity A compared to quantity B
- **Ratio notation**: A:B or A/B
- **Parts concept**: Total parts = A + B
...
**Solution:**
- Let total mixture = 1+2 = 3 parts
- A contributes: 1/3 of total
- A's composition: 2:3 milk:water
- B contributes: 2/3 of total
- B's composition: 4:1 milk:water

### Example 3: Ratio from Quantities
**20 kg sugar, 30 kg flour, 10 kg butter. Find ratio.**

**Solution:**
- Ratio = 20:30:10 = 2:3:1
...
A:B = x:y
B:C = m:n
Then A:B:C = x:y:z where y = m, z = n
\`\`\`

### **Ratio Division**
\`\`\`
A:B = x:y
Divide each by d: (x/d):(y/d)
\`\`\`
...
\`\`\`
Divide by GCD: 4:6 = 2:3
\`\`\`

### **Equal Ratio Mixing**
\`\`\`
When mixed in same ratio as individual ratios:
Final ratio remains same
\`\`\`
...
### Example 5: Cost Ratio
**Two types sugar: Rs. 40/kg, Rs. 50/kg. Mixed in 2:3 ratio. Average price?**
...
**3.** Two mixtures A(3:4), B(5:3) mixed 2:3. Final ratio?
**4.** A:B:C = 2:3:4. Total 45 units. B quantity?
**5.** 40% A, 60% B. Ratio A:B?

**Answers:** 1. 20L, 2. 4kg, 3. Complex calculation needed, 4. 18 units, 5. 2:3
...
3. **Use fraction method** for quantity calculations
