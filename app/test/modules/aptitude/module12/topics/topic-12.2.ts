...
- Can be miscible (mix completely) or immiscible (separate layers)
- Examples: Milk + Water, Oil + Water, Alcohol + Water

### **Key Properties**
- **Density differences**: May form layers
- **Volume changes**: May not be additive
- **Concentration**: Measured in percentages or ratios
...
**Oil and Water**
- Immiscible mixture
- Oil floats on water due to lower density
...
- Common in everyday problems
- Examples: Salt + Water, Sugar + Tea, Medicine + Water

### **Key Properties**
- **Solubility**: How much solid dissolves in liquid
- **Saturation**: Maximum amount that can dissolve
- **Concentration**: Measured in grams per liter or percentage
...
- Sweetness depends on sugar concentration
...
- Examples: Alloys (Copper + Zinc), Cement mixture
- Properties depend on proportions

### **Gas Mixtures**
- All ingredients are gases
- Example: Air (78% Nitrogen, 21% Oxygen, 1% others)
- Follow gas laws

### **Complex Mixtures**
- Multiple phases (solid + liquid + gas)
...
Properties depend on constituent ratios
\`\`\`
...
- Cost per liter = 80/5 = Rs. 16/liter

### Example 2: Solid-Liquid
**200g sugar dissolved in 800g water. Find concentration.**
...
### **Liquid-Liquid Mixtures**
\`\`\`
If volumes are additive: Total volume = V1 + V2
Cost calculation: Same as any mixture
\`\`\`
...
- Milk is an emulsion (fat globules in water)

### **Suspensions**
- Particles don't dissolve
- Muddy water, chalk in water
...
3. **Cost Assumptions**: Thinking water has zero cost
4. **Concentration Units**: Mixing percentage by mass/volume
5. **Property Changes**: Ignoring density/concentration effects
...
**3.** 2kg gold @ Rs.2000/kg + 1kg silver @ Rs.500/kg. Average price?
**4.** Oil:water = 1:4 in 25L mixture. Oil quantity?
**5.** 150g sugar in 850g solution. Sugar %?

**Answers:** 1. Rs. 20/L, 2. 30%, 3. Rs. 1666.67/kg, 4. 5L, 5. 15%
...
3. **Apply appropriate formulas** for each type
