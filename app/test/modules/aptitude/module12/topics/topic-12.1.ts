...
- **Properties**: Average of individual properties
- **Quantities**: Can be measured by weight, volume, or value
...
\`\`\`
Concentration = (Quantity of ingredient) / (Total quantity)
Proportion = Ratio of ingredients in the mixture
\`\`\`
...
**5 liters water mixed with 3 liters milk. What percentage of mixture is milk?**
...
- **Solid-Solid**: Sand + Cement, Flour + Sugar
- **Gas-Gas**: Air (Oxygen + Nitrogen)

### **Based on Properties**
- **Price-based**: Different costs per unit
- **Quality-based**: Different concentrations/purities
- **Weight-based**: Different densities
...
\`\`\`
Average price = (Total cost) / (Total quantity)
Always calculate total cost first
\`\`\`
...
### Example 5: Different Units
**5 liters oil at Rs. 100/liter mixed with 3 kg ghee at Rs. 200/kg. Find average price per kg.**
...
**3.** 25% salt solution. If total 100 liters, salt quantity?
**4.** 3 ingredients: 10kg@Rs.20, 15kg@Rs.25, 5kg@Rs.30. Average price?
**5.** Oil:water = 2:3 in 25 liters mixture. Oil quantity?

**Answers:** 1. Rs. 36/kg, 2. 36 liters, 3. 25 kg, 4. Rs. 24.67/kg, 5. 10 liters
...
3. **Calculate total cost** and total quantity separately
