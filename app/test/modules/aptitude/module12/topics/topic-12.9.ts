...
export const topic_12_9: SubLesson = {
  ...
  status: 'completed',
  content: "`# ðŸ” Finding Quantity of Each Ingredient
...
**Solution:**
- Total parts = 4 + 1 = 5
- Milk quantity = (4/5) Ã— 45 = 36 liters
- Water quantity = (1/5) Ã— 45 = 9 liters
...
- Quantity A = (1/3) Ã— 30 = 10 kg at Rs. 40
- Quantity B = (2/3) Ã— 30 = 20 kg at Rs. 50
- Verify: Cost = (10Ã—40 + 20Ã—50)/30 = (400 + 1000)/30 = 1400/30 = Rs. 46.67/kg
...
**Solution:**
- Ratio 1:2, total parts = 3
- 20% solution = (1/3) Ã— 30 = 10 liters
- 60% solution = (2/3) Ã— 30 = 20 liters
- Verify: Acid = (0.2Ã—10 + 0.6Ã—20) = (2 + 12) = 14 liters
...
## ðŸŽ¯ Reverse Engineering Techniques
...
Quantity A = (a/(a+b)) Ã— T
Quantity B = (b/(a+b)) Ã— T
\`\`\`

### **Percentage Method**
\`\`\`
If A is p% of mixture:
Quantity A = (p/100) Ã— Total
\`\`\`
...
- Pure ingredient from A: 0.4 Ã— 30 = 12 kg
...
- A = (2/11)Ã—42 â‰ˆ 7.64L
- B = (3/11)Ã—42 â‰ˆ 11.45L
- C = (6/11)Ã—42 â‰ˆ 22.91L
...
- Quantity A = (3/5)Ã—50 = 30 kg
- Quantity B = (2/5)Ã—50 = 20 kg

---

## ðŸš¨ Quantity Finding Mistakes
...
## ðŸŽ“ Quantity Finding Strategies
...
Master finding ingredient quantities and work backwards from mixture properties! ðŸ†`
};
