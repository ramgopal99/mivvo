...
### **Distance Closure**
\`\`\`
Distance decreases at relative speed
...
- **Circular motion**: Different relative calculations
- **Variable speeds**: Changing relative speeds over time

### **Complex Scenarios**
- **Trains in opposite directions**
- **Cars on different roads**
- **Objects moving in different patterns**

### **Real-World Applications**
- **Traffic problems**: Overtaking scenarios
- **Railway crossings**: Train meeting times
- **Sports**: Race finishing times
...
**Solution:**
- A relative to B: 60 - 40 = 20 km/h
- B relative to A: 40 - 60 = -20 km/h (A catching B)
- A relative to C: 60 - 50 = 10 km/h
- C relative to A: 50 - 60 = -10 km/h
...
- Time for faster to lap slower = 400 / 2 = 200 seconds
...
3. **Distance misunderstanding**: Total vs remaining distance
4. **Time calculation**: Forgetting unit conversions
5. **Multiple objects**: Wrong pairwise combinations
...
**3.** Two cyclists start together, one at 15 km/h, other at 12 km/h. Distance after 1 hour?
**4.** Train A 200m at 60 km/h, Train B 150m at 40 km/h towards each other. Crossing time?
**5.** Car A 50 km/h, Car B 30 km/h same direction, 5 km apart. Catching time?

**Answers:** 1. 1.25 hours, 2. 40 seconds, 3. 3 km, 4. 15 seconds, 5. 0.33 hours
...
3. **Convert units** to match distance units
