...
## 📊 Types of Average Speed Problems
...
**Solution:**
- Distance1 = 50 × 2 = 100 km
- Distance2 = 60 × 3 = 180 km
...
\`\`\`
Average speed = Σ (Speed × Time) / Σ Time
OR
Average speed = Σ (Speed × Distance) / Σ Distance
\`\`\`
...
\`\`\`
If distances equal: Average = (S1 + S2)/2 × correction factor
If times equal: Average = (D1 + D2)/(T1 + T2) × correction factor
\`\`\`

---

## 🔢 Advanced Average Speed
...
- Average speed = 8000/2700 ≈ 2.96 m/s

---

## 🚨 Average Speed Mistakes

1. **Arithmetic mean error**: Average speed ≠ (S1 + S2)/2
...
Master average speed calculations and handle complex journey problems with ease! 🏆`
};