...
\`\`\`
Distance won = Speed difference Ã— Time
\`\`\`
...
- In 25 seconds, A covers 10 Ã— 25 = 250 m
- B covers 8 Ã— 25 = 200 m
- A wins by 50m
...
- Distance B covers in 50 seconds = 6 Ã— 50 = 300 m
...
### **Head Start Formula**
\`\`\`
Head start distance = Relative speed Ã— Time difference
\`\`\`

### **Winning Margin**
\`\`\`
Distance won = (Speed A - Speed B) Ã— Race time
\`\`\`
...
- B covers in 20s: 8Ã—20 = 160m + 20m start = 180m from start
- C covers in 20s: 6Ã—20 = 120m + 40m start = 160m from start
...
- 15S = 95 â‡’ S = 95/15 = 6.33 m/s

### Example 6: Relay Race
**4Ã—100m relay. Each runner 10 m/s. Baton exchange takes 2 seconds. Team time?**

**Solution:**
- Each runner runs 100m at 10 m/s = 10 seconds
- 3 exchanges Ã— 2 seconds = 6 seconds
- Total time = 40 + 6 = 46 seconds

---

## ðŸš¨ Race Problem Mistakes
...
**5.** Relay: 4Ã—50m, each at 8 m/s, 1 second exchanges. Total time?

**Answers:** 1. A wins by 10m, 2. Complex calculation needed, 3. 66.67m, 4. 6.25 m/s, 5. 28 seconds

---

## ðŸŽ“ Race Problem Strategies
...
Master race and competition problems and handle competitive scenarios! ðŸ†`
};
