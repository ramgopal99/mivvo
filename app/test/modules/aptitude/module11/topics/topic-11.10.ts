...
2. **Identify concepts** - Speed, time, distance relationships
3. **Draw diagrams** - Visualize motion scenarios
4. **Assign variables** - Let unknowns be variables
5. **Set up equations** - Based on relationships
6. **Solve systematically** - Step by step
7. **Verify answer** - Check reasonableness
...
**Solution:**
- Distance = 200 km, Time = 2 hours
- Relative speed = 200/2 = 100 km/h

### 3. **Train Crossing Problems**
**"Train A 150m long at 60 km/h crosses train B 120m long at 40 km/h moving towards. Time?"**
...
### **Efficiency Checks**
\`\`\`
Check if speeds make sense
Verify unit consistency
Ensure time/distance relationships hold
\`\`\`
...
- Time2 = 60/30 = 2h
- Time3 = 50/25 = 2h
- Total distance = 40 + 60 + 50 = 150 km
- Total time = 6h
- Average speed = 150/6 = 25 km/h

### Example 2: Boats in Streams
...
3. **Unit confusion**: Mixing km/h with m/s
4. **Time synchronization**: When events actually occur
5. **Multiple variables**: Too many unknowns

### **Common Traps**
- **"Average speed"**: Harmonic vs arithmetic mean
- **"Returns at same speed"**: May not be true
- **"Meets again"**: Direction changes
- **"Overtakes"**: Relative speed application
- **"Platform crossing"**: Add lengths correctly
...
**3.** Boat goes 30 km downstream in 2h, returns in 2.5h. Boat speed?
**4.** Two trains 150m, 120m at 54 km/h, 72 km/h towards. Crossing time?
**5.** Runner gives another 50m head start in 400m race. Speeds 8 m/s, 6 m/s. Winner?

**Answers:** 1. 75 km/h, 2. 2 hours, 3. 13.33 km/h, 4. 10 seconds, 5. First runner wins
...
4. **Identify problem type** - Journey, meeting, crossing, etc.
5. **Use appropriate formulas** - Don't force wrong relationships
