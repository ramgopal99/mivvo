...
### **Key Points**
- Rate determines interest amount
...
- May not include additional charges
- Example: 10% per annum

### **2. Effective Rate**
- Actual rate after considering all factors
- Includes processing fees, compound effects
- Example: 10.5% effective annual rate
...
2. **Monthly Rate**: Per month
3. **Daily Rate**: Per day
4. **Quarterly Rate**: Per quarter

### **Based on Application**
1. **Lending Rate**: For loans
2. **Deposit Rate**: For savings
3. **Investment Rate**: For investments
4. **Discount Rate**: For bills/exchanges
...
- Fixed Deposit: 5-7% per annum
- Home Loan: 6.5-8% per annum
...
- Corporate Bonds: 7-9%
- Mutual Funds: 8-12%
- Stock Market: Variable (10-15% average)
...
- 2000s: 8-12% rates
- 2010s-2020s: 6-10% rates
- Current: 3-8% depending on instrument

### **2. Future Expectations**
- Gradual decrease with economic stability
- Technology impact on peer-to-peer lending
- Government policies influence rates
...
2. Annual rate 12%, find monthly equivalent.
3. Daily rate 0.025%, find annual rate.
