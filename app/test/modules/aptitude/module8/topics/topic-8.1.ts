...
### **Key Points**
- Principal is the base amount for interest calculation
- Interest is always calculated as a percentage of principal
- Principal remains constant throughout the loan/investment period
...
### **2. Investment Principal**
- Amount invested by investor
- Generates returns with interest
- Example: Fixed deposits, bonds, savings accounts

### **3. Deposit Principal**
- Amount deposited in bank
- Earns interest for depositor
- Example: Savings account balance, term deposits

### **4. Business Principal**
- Capital invested in business
- Basis for profit/loss calculations
- Example: Startup capital, working capital
...
### **1. Lending Context**
\`\`\`
Borrower takes P from lender
Pays back P + Interest
\`\`\`

### **2. Investment Context**
\`\`\`
Investor gives P to institution
Receives back P + Interest
\`\`\`

### **3. Banking Context**
\`\`\`
Depositor deposits P in bank
Bank pays P + Interest
\`\`\`
...
- Only interest accumulates over time

### **2. Principal is Always Positive**
- Cannot be zero or negative
- Minimum principal depends on lender/institution
...
- P is the reference point for returns/costs
...
|-------------|-------------|-------------------|
| Principal | Original amount | P |
| Interest | Earnings/cost on P | Function of P |
| Amount | P + Interest | Includes P |
| Balance | Remaining amount | Part of P + Interest |
...
- Interest is additional earnings/cost
