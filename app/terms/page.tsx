...
import { termsConfig } from "@/config/pages"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl">{termsConfig.introduction.title}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            {termsConfig.introduction.content.map((paragraph, index) => (
        ...
        {/* Dynamic Sections */}
        {termsConfig.sections.map((section, sectionIndex) => (
        ...
        <Card className="mt-8">
          <CardHeader>
            <CardTitle className="text-2xl">{termsConfig.contact.title}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
